...
<ul id="wb-tphp">
	...
	_e("<!--:en--><li class=\"wb-slc visible-md visible-lg\"> <a class=\"wb-sl\" href=\"#wb-sec\">Skip to section menu</a></li><!--:--><!--:fr--><li class=\"wb-slc visible-md visible-lg\"> <a class=\"wb-sl\" href=\"#wb-sec\">Passer au menu de section</a></li><!--:-->");
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <section class="wb-mb-links col-xs-12 visible-sm visible-xs" id="wb-glb-mn">
                            <h2><?php _e("<!--:en-->Search and menus<!--:--><!--:fr-->Recherche et menus<!--:-->"); ?></h2>
                            <ul class="pnl-btn list-inline text-right">
<li><a href="#mb-pnl" title="Search and menus" aria-controls="mb-pnl" class="overlay-lnk btn btn-sm btn-default" role="button"><span class="glyphicon glyphicon-search"><span class="glyphicon glyphicon-th-list"><span class="wb-inv"><?php _e("<!--:en-->Search and menus<!--:--><!--:fr-->Recherche et menus<!--:-->"); ?></span></span></span></a></li>
                            </ul>
                            <div id="mb-pnl"></div>
                        </section>
                    </div>
